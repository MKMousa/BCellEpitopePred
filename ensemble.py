...
def NewshufflePosNeg(data2):
	...
	data2_over = data2.to_numpy()[index]
...
def get_matrix(windows_pos,windows_neg):
	...
	windows_all = windows_all.to_numpy()	
...
for t in range(0,iteration_times):
	...
	matrix_train_windows_all = train_windows_all.to_numpy()
