...
def OnehotNetwork(train_oneofkeyX,trainY,val_oneofkeyX,valY,
	...
	if (train_time==0):
		x = Conv1D(201,2,kernel_initializer='glorot_normal',kernel_regularizer= l1(0),padding="same")(Oneofkey_input)
		x = Dropout(0.4)(x)
		x = Activation('relu')(x)

		x = Conv1D(151,3,kernel_initializer='glorot_normal',kernel_regularizer= l2(0),padding="same")(x)
		x = Dropout(0.4)(x)
		x = Activation('relu')(x)

		x = Conv1D(151,5,kernel_initializer='glorot_normal',kernel_regularizer= l2(0),padding="same")(x)
		x = Dropout(0.4)(x)
		x = Activation('relu')(x)

		x = Conv1D(101,7,kernel_initializer='glorot_normal',kernel_regularizer= l2(0),padding="same")(x)
		x = Dropout(0.4)(x)
		x = Activation('relu')(x)
		...
		Oneofkey_output = Dense(2,kernel_initializer='glorot_normal',activation='softmax',kernel_regularizer= l2(0.001))(x)
		
		OnehotNetwork = Model(Oneofkey_input,Oneofkey_output)
		
		optimization='Nadam'
		OnehotNetwork.compile(loss='binary_crossentropy',optimizer=optimization,metrics=[tensorflow.keras.metrics.binary_accuracy])
	else:
	...
	if(trainY is not None):
		...
		onehotfitHistory = OnehotNetwork.fit(train_oneofkeyX,trainY,batch_size=4096,epochs=50,shuffle=True,callbacks=[early_stopping,loss_checkpointer,weight_checkpointer],class_weight=None,validation_data=(val_oneofkeyX,valY))
...
def OtherNetwork(train_physicalXo,trainY,val_physicalXo,valY,
	...
	if (train_time==0):
		x = Conv1D(201,2,kernel_initializer='glorot_normal',kernel_regularizer= l2(0),padding="same")(physical_O_input)
		x = Dropout(0.2)(x)
		x = Activation('relu')(x)
		...
		x = Flatten()(x)
		x = BatchNormalization()(x)
		physical_O_output = Dense(2,kernel_initializer='glorot_normal',activation='softmax',kernel_regularizer=l2(0.001))(x)

		OtherNetwork = Model(physical_O_input,physical_O_output)
		
		optimization='Nadam'
		OtherNetwork.compile(loss='binary_crossentropy',optimizer=optimization,metrics=[tensorflow.keras.metrics.binary_accuracy])
	else:
	...
	if(trainY is not None):
		...
		OfitHistory = OtherNetwork.fit(train_physicalXo,trainY,batch_size=4096,epochs=50,shuffle=True,callbacks=[early_stopping,loss_checkpointer,weight_checkpointer],class_weight=None,validation_data=(val_physicalXo,valY))                
...
def PhysicochemicalNetwork(train_physicalXp,trainY,val_physicalXp,valY,
	...
	if (train_time==0):
		x = Conv1D(201,2,kernel_initializer='glorot_normal',kernel_regularizer= l2(0),padding="same")(physical_P_input)
		x = Dropout(0.3)(x)
		x = Activation('relu')(x)
		...
		x = Conv1D(101,5,kernel_initializer='glorot_normal',kernel_regularizer= l2(0),padding="same")(x)
		x = Dropout(0.1)(x)
		x = Activation('relu')(x)

		x = Flatten()(x)
		x = BatchNormalization()(x)
		physical_P_output = Dense(2,kernel_initializer='glorot_normal',activation='softmax',kernel_regularizer=l2(0.001))(x)

		PhysicochemicalNetwork = Model(physical_P_input,physical_P_output)
		
		optimization='Nadam'
		PhysicochemicalNetwork.compile(loss='binary_crossentropy',optimizer=optimization,metrics=[tensorflow.keras.metrics.binary_accuracy])
	else:
	...
	if(trainY is not None):
		...
		PfitHistory = PhysicochemicalNetwork.fit(train_physicalXp,trainY,batch_size=4096,epochs=50,shuffle=True,callbacks=[early_stopping,loss_checkpointer,weight_checkpointer],class_weight=None,validation_data=(val_physicalXp,valY))                
...
def HydrophobicityNetwork(train_physicalXh,trainY,val_physicalXh,valY,
	...
	if (train_time==0):
		x = Conv1D(201,2,kernel_initializer='glorot_normal',kernel_regularizer= l2(0),padding="same")(physical_H_input)
		x = Dropout(0.4)(x)
		x = Activation('relu')(x)
		...
		x = Conv1D(51,7,kernel_initializer='glorot_normal',kernel_regularizer= l2(0),padding="same")(x)
		x = Dropout(0.1)(x)
		x = Activation('relu')(x)

		x = Flatten()(x)
		x = BatchNormalization()(x)
		physical_H_output = Dense(2,kernel_initializer='glorot_normal',activation='softmax',kernel_regularizer=l2(0.001))(x)

		HydrophobicityNetwork = Model(physical_H_input,physical_H_output)
		
		optimization='Nadam'
		HydrophobicityNetwork.compile(loss='binary_crossentropy',optimizer=optimization,metrics=[tensorflow.keras.metrics.binary_accuracy])
	else:
	...
	if(trainY is not None):
		...
		HfitHistory = HydrophobicityNetwork.fit(train_physicalXh,trainY,batch_size=4096,epochs=50,shuffle=True,callbacks=[early_stopping,loss_checkpointer,weight_checkpointer],class_weight=None,validation_data=(val_physicalXh,valY))                
...
def CompositionNetwork(train_physicalXc,trainY,val_physicalXc,valY,
	...
	if (train_time==0):
		x = Conv1D(201,2,kernel_initializer='glorot_normal',kernel_regularizer= l2(0),padding="same")(physical_C_input)
		x = Dropout(0.2)(x)
		x = Activation('relu')(x)
		...
		x = Flatten()(x)
		x = BatchNormalization()(x)
		physical_C_output = Dense(2,kernel_initializer='glorot_normal',activation='softmax',kernel_regularizer=l2(0.001))(x)

		CompositionNetwork = Model(physical_C_input,physical_C_output)
		
		optimization='Nadam'
		CompositionNetwork.compile(loss='binary_crossentropy',optimizer=optimization,metrics=[tensorflow.keras.metrics.binary_accuracy])
	else:
	...
	if(trainY is not None):
		...
		CfitHistory = CompositionNetwork.fit(train_physicalXc,trainY,batch_size=4096,epochs=50,shuffle=True,callbacks=[early_stopping,loss_checkpointer,weight_checkpointer],class_weight=None,validation_data=(val_physicalXc,valY))                     	
...
def BetapropensityNetwork(train_physicalXb,trainY,val_physicalXb,valY,
	...
	if (train_time==0):
		x = Conv1D(201,2,kernel_initializer='glorot_normal',kernel_regularizer= l2(0),padding="same")(physical_B_input)
		x = Dropout(0.3)(x)
		x = Activation('relu')(x)
		...
		x = Flatten()(x)
		x = BatchNormalization()(x)
		physical_B_output = Dense(2,kernel_initializer='glorot_normal',activation='softmax',kernel_regularizer=l2(0.001))(x)

		BetapropensityNetwork = Model(physical_B_input,physical_B_output)
		
		optimization='Nadam'
		BetapropensityNetwork.compile(loss='binary_crossentropy',optimizer=optimization,metrics=[tensorflow.keras.metrics.binary_accuracy])
	else:
	...
	if(trainY is not None):
		...
		BfitHistory = BetapropensityNetwork.fit(train_physicalXb,trainY,batch_size=4096,epochs=50,shuffle=True,callbacks=[early_stopping,loss_checkpointer,weight_checkpointer],class_weight=None,validation_data=(val_physicalXb,valY))                
...
def AlphaturnpropensityNetwork(train_physicalXa,trainY,val_physicalXa,valY,
	...
	if (train_time==0):
		x = Conv1D(201,2,kernel_initializer='glorot_normal',kernel_regularizer= l2(0),padding="same")(physical_A_input)
		x = Dropout(0.4)(x)
		x = Activation('relu')(x)
		...
		x = Flatten()(x)
		x = BatchNormalization()(x)
		physical_A_output = Dense(2,kernel_initializer='glorot_normal',activation='softmax',kernel_regularizer=l2(0.001))(x)

		AlphaturnpropensityNetwork = Model(physical_A_input,physical_A_output)
		
		optimization='Nadam'
		AlphaturnpropensityNetwork.compile(loss='binary_crossentropy',optimizer=optimization,metrics=[tensorflow.keras.metrics.binary_accuracy])
	else:
	...
	if(trainY is not None):
		...
		AfitHistory = AlphaturnpropensityNetwork.fit(train_physicalXa,trainY,batch_size=4096,epochs=50,shuffle=True,callbacks=[early_stopping,loss_checkpointer,weight_checkpointer],class_weight=None,validation_data=(val_physicalXa,valY))                  	
